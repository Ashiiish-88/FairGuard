        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-12 relative">
            ...
            <div className="pt-[10vh] pb-[40vh] space-y-[35vh]" id="hiw-steps">
              {/* Step 1: Upload */}
              <div className="hiw-step bg-transparent" data-step="0">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-gray-50 border border-[#caff3d]/20 rounded-lg flex items-center justify-center text-[#000000]">
                    <Upload className="w-5 h-5" />
                  </div>
                  <div>
                    <span className="block text-[10px] font-bold tracking-[0.2em] text-[#9CA3AF]">01</span>
                    <h3 className="text-[28px] font-extrabold text-[#000000]" style={{ fontFamily: "var(--font-heading)" }}>Upload</h3>
                  </div>
                </div>
                <p className="text-[17px] text-[#4B5563] leading-[1.7] mb-4 font-medium">
              ...
              {/* Step 2: Analyze */}
              <div className="hiw-step bg-transparent" data-step="1">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-gray-50 border border-[#caff3d]/20 rounded-lg flex items-center justify-center text-[#000000]">
                  ...
                  <div>
                    ...
                    <h3 className="text-[28px] font-extrabold text-[#000000]" style={{ fontFamily: "var(--font-heading)" }}>Analyze</h3>
                  </div>
                </div>
                <p className="text-[17px] text-[#4B5563] leading-[1.7] mb-4 font-medium">
              ...
              {/* Step 3: Act */}
              <div className="hiw-step bg-transparent" data-step="2">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-gray-50 border border-[#caff3d]/20 rounded-lg flex items-center justify-center text-[#000000]">
                  ...
                  <div>
                    ...
                    <h3 className="text-[28px] font-extrabold text-[#000000]" style={{ fontFamily: "var(--font-heading)" }}>Act</h3>
                  </div>
                </div>
                <p className="text-[17px] text-[#4B5563] leading-[1.7] mb-4 font-medium">
...
<span style="display:block;background:rgba(255,107,122,0.1);padding:0 4px;margin:0 -4px;color:#ff6b7a">- "Anjali" -> "dedicated team player"</span>` }}
      ...
      <section className="relative bg-white overflow-hidden min-h-[380px] flex items-center">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 h-[700px] w-[55%] hidden md:block">
          ...
          >
            {[38, 30, 42, 25, 48, 20, 44, 32, 50, 28, 46, 35, 40, 22].map((offset, i) => (
              <div
                key={i}
                className="w-full shrink-0 stripe-hover-effect"
                style={{
                  height: "50px",
                  background: `linear-gradient(to right, transparent ${offset}%, #caff3d ${offset + 15}%, #04cfff ${offset + 40}%, #2563EB 100%)`,
                }}
              />
            ))}
          </motion.div>
